 ...
 */
public class GenericPostInteractor extends PlayBasisApiInteractor {

  public static final String TAG = "GenericPostInteractor";

  protected GenericForm genericForm;

  @Inject
  public GenericPostInteractor(PBThreadExecutor threadExecutor,
