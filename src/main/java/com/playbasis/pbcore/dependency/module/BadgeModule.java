...
public class BadgeModule {
  ...
  @Provides
  @PerActivity
  GetAllBadgesInteractor provideGetAllBadgesInteractor(PBThreadExecutor threadExecutor,
                                                       PBPostExecutionThread postExecutionThread,
                                                       RestClient restClient,
                                                       RequestTokenInteractor requestTokenInteractor) {
    return new GetAllBadgesInteractor(threadExecutor, postExecutionThread, restClient, requestTokenInteractor);
  }
