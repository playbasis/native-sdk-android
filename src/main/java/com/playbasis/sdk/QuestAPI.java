...
public class QuestAPI {
  ...
  public static void questListInfo(QuestListInfoForm form, QuestListInfoCallback callback) {
    ...
    instance().getQuestListInteractor.execute(new BaseApiSubscriber<>(callback));
  }
  ...
  public static void questInfo(QuestInfoForm form, QuestInfoCallback callback) {
    ...
    instance().getQuestInfoInteractor.execute(new BaseApiSubscriber<>(callback));
  }
  ...
  public static void questLeaderBoard(QuestLeaderBoardForm form, QuestLeaderBoardCallback callback) {
    ...
    instance().getQuestLeaderboardInteractor.execute(new BaseApiSubscriber<>(callback));
  }
  ...
  public static void joinQuest(JoinQuestForm form, JoinQuestCallback callback) {
    ...
    instance().joinQuestInteractor.execute(new BaseApiSubscriber<>(callback));
  }
  ...
  public static void cancelQuest(CancelQuestForm form, CancelQuestCallback callback) {
    ...
    instance().cancelQuestInteractor.execute(new BaseApiSubscriber<>(callback));
  }
  ...
  public static void missionInfo(MissionInfoForm form, MissionInfoCallback callback) {
    ...
    instance().getMissionInfoInteractor.execute(new BaseApiSubscriber<>(callback));
  }
  ...
  public interface QuestListInfoCallback extends BasicApiCallbackWithResult<List<Quest>> {

  }

  public interface QuestInfoCallback extends BasicApiCallbackWithResult<Quest> {

  }

  public interface QuestLeaderBoardCallback extends BasicApiCallbackWithResult<List<QuestPlayerRank>> {

  }

  public interface JoinQuestCallback extends BasicApiCallback {

  }

  public interface CancelQuestCallback extends BasicApiCallback {

  }

  public interface MissionInfoCallback extends BasicApiCallbackWithResult<Mission> {
